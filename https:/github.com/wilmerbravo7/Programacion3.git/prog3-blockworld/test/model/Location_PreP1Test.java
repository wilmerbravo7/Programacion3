...
public class Location_PreP1Test {
    ...
    public final void testConstructor_2() {
    	Location lx;
    	lx = new Location(earth,15.7,12345.6,-18.9);
    	assertSame("getWorld", earth,lx.getWorld());
    	assertEquals("getX", 15.7, lx.getX(),0.01);
    	assertEquals("getY", Location.UPPER_Y_VALUE, lx.getY(),0.01);
    ...
    public final void testCopyConstructor() {
    	...
    	assertSame("getWorld", earth, ly.getWorld());
    	assertEquals("getX", 1.1, ly.getX(),0.01);
    	assertEquals("getY",2.2, ly.getY(),0.01);
    	assertEquals("getZ",3.3, ly.getZ(),0.01);
    ...
    /**
     * comprueba que la operacion add() siempre devuelve this
     */
    @Test
    ...
    public final void testAdd_Y_OutOfRange() {
    	...
    	Location loc = lup.add(le);
    	le.add(lup);
    	assertSame("getWorld", earth, lup.getWorld());
        assertEquals("getX", 4.4, lup.getX(),0.01); 
        assertEquals("getY", lup.UPPER_Y_VALUE, lup.getY(),0.01);
        assertEquals("getZ", 4.4, lup.getZ(),0.01);
